...
const searchUsers = (keyword) => axios.get(`${API_URL}/search?keyword=${encodeURIComponent(keyword)}`);
const filterUsersByRole = (role) => axios.get(`${API_URL}/filter?role=${encodeURIComponent(role)}`)

export { getUsers, getUserById, addUser, updateUser, deleteUser, searchUsers, filterUsersByRole };