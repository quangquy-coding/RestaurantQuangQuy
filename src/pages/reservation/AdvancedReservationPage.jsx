...
const AdvancedReservationPage = () => {
    ...
    try {
      ...
      if (err.response) {
        ...
        if (
          ...
          errorData.includes("MaKhachHang not found")
        ) {
          setError(
            "Không tìm thấy thông tin khách hàng. Vui lòng kiểm tra lại thông tin đăng nhập."
          );
        } else if (status === 400) {
          setError(
            typeof errorData === "string"
              ? errorData
              : "Thông tin đặt bàn không hợp lệ."
          );
        } else {
          setError(
            typeof errorData === "string" ? errorData : "Đặt bàn thất bại."
          );
        }
      } else if (err.request) {
    ...
    return (
      <div className="mb-6">
        <h3 className="text-lg font-semibold mb-4">
          Chọn giờ ({availableTimes.length} khung giờ có sẵn)
        </h3>
  ...
  const renderStep1 = () => (
    <div className="max-w-2xl mx-auto bg-gray-50 rounded-lg shadow-md p-4 mb-6">
      <div className="mb-6">
        ...
        <div>
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-500 mt-1">
              Số lượng khách ảnh hưởng đến khung giờ có sẵn
            </p>
          </div>
          {renderCalendar()}
        </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <ul className="mt-2 list-disc list-inside space-y-1 text-sm text-blue-700">
              <li>
                Vui lòng đến đúng giờ. Bàn sẽ được giữ trong vòng 15 phút.
              </li>
  ...
  const renderConfirmation = () => (
    <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-8 text-center">
      ...
      <p className="text-gray-600 mb-6">
        Cảm ơn bạn đã đặt bàn tại nhà hàng của chúng tôi. Chúng tôi đã gửi email
        xác nhận đến {customerInfo.email}.
      </p>
    ...
    <div className="container mx-auto px-4 py-8 min-h-screen bg-red-50">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Đặt bàn trước để đảm bảo trải nghiệm ẩm thực tuyệt vời của bạn
        </p>
      </div>
